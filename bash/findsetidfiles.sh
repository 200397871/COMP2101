...
#find /home/ -type f -exec ls -alh  --block-size=M {} \; | sort -hr -k5 | head -n 10 | cut -d' ' -f5,3,9
#find /home/ -type f -exec ls -alh  --block-size=M {} \; | sort -hr -k5 | head -n 10 | awk '{print $5, $3, $NF}'
#find /home/ -type f -exec ls -alh  --block-size=M {} \; | sort -hr -k5 | head -n 10 | awk 'NR>2{ print $5, $3, $9}'
#find /home/ -type f -exec ls -alh  --block-size=M {} \; | sort -hr -k5 | head -n 10 | gawk '{print $5, $3, $9}'
#find /home/ -type f -exec ls -l --block-size=M {} \; | sort -hr -k5 | head -n 10 | gawk '{print $5, $3, $9}'


find /home/ -type f -exec ls -l --block-size=M {} + | sort -rh -k5 | head -n 10 |  cut -d' ' -f5,3,9
